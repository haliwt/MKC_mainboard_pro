...
void wk_adc1_init(void)
{
  ...
  gpio_init_struct.gpio_pins = ADC_DET24V_PIN;
  gpio_init(ADC_DET24V_GPIO_PORT, &gpio_init_struct);

  /* configure the IN8 pin */
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = ADC_TEMP_PIN;
  gpio_init(ADC_TEMP_GPIO_PORT, &gpio_init_struct);

  /* configure the IN9 pin */
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = ADC_WATER_PIN;
  gpio_init(ADC_WATER_GPIO_PORT, &gpio_init_struct);
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_9, 3, ADC_SAMPLETIME_7_5 );
